...
INSERT INTO EMPLOYEES (id, first_name, last_name, address, phone_number, hire_date, departure_date, status, contract_type, position_id) VALUES(hibernate_sequence.NEXTVAL, 'Nikoletta',  'Michopoulou',  'Athinas 172', '6983216548', '2012-04-16', '1900-01-01', 2, 1, 1);
INSERT INTO EMPLOYEES (id, first_name, last_name, address, phone_number, hire_date, departure_date, status, contract_type, position_id) VALUES(hibernate_sequence.NEXTVAL, 'Filippos',  'Kontos',  'Athinas 172', '6983216548', '2012-04-16', '1900-01-01', 3, 1, 2);
INSERT INTO EMPLOYEES (id, first_name, last_name, address, phone_number, hire_date, departure_date, status, contract_type, position_id) VALUES(hibernate_sequence.NEXTVAL, 'Dimitra',  'Fountzoula',  'Athinas 172', '6983216548', '2012-04-16', '1900-01-01', 1, 1, 2);
INSERT INTO EMPLOYEES (id, first_name, last_name, address, phone_number, hire_date, departure_date, status, contract_type, position_id) VALUES(hibernate_sequence.NEXTVAL, 'Michael',  'Stefanoudis',  'Athinas 172', '6983216548', '2012-04-16', '1900-01-01', 6, 1, 3);
...
INSERT INTO EMPLOYEES (id, first_name, last_name, address, phone_number, hire_date, departure_date, status, contract_type, position_id) VALUES(hibernate_sequence.NEXTVAL, 'Sarah', 'James', 'Wall St.', '6947368142', '2010-07-10', '2018-11-01', 5, 1, 2);
